...
att = AttentionHead(input_dim=32 * 32, query_dim=512, encoding_dim=512)
...
decoder = torch.nn.Linear(512, 1)
assert(output_seq.shape == torch.Size((10, 512)))
...
for layer, name in zip((att.query, att.key, att.value), ("query", "key", "value")):
